...
// The low-end cuts mirror the AU employee length distribution used for VER-523:
// address median ≈36 chars, P95 ≈48, P99 ≈58, and P99.9 ≈80. The remaining
// cuts are stress/capacity boundaries rather than representative AU records.
const ADDRESS_LENGTHS = [0, 32, 36, 40, 48, 58, 80, 120, 160, 200, 240, 280, 320, 321];
...
function isRepresentative(result) {
  return (
    ...
    [0, 36, 48, 58, 80, 120, 240, 320].includes(result.addressUtf8Bytes) &&
    ["minimal", "au-typical", "jobtitle-absent", "representative", "dense-fields"].includes(
      result.density,
    )
  );
}
